...
export function MobileMenuOptions() {
    ...
    const [active, setActive] = useState<0 | 1 | 2 | null>(initialOption(pathname));

    useEffect(() => {
        setActive(initialOption(pathname));
    }, [pathname]);
    return (
        <>
            {pathname !== '/' && (
                <div className="flex justify-between items-center gap-4 w-full bg-[#101010d1] h-[70px] px-8 md:hidden">
                    <div role="button">
                        ...
                        >
                            ...
                            {
                                <p className={`text-xs text-gray ${active === 0 && 'text-white'}`}>
                                    Home
                                </p>
                            }
                        </Link>
                    ...
                    <div role="button">
                        ...
                        >
                            ...
                            {
                                <p className={`text-xs text-gray ${active === 1 && 'text-white'}`}>
                                    Search
                                </p>
                            }
                        </Link>
                        ...
                        >
                            {pathname !== '/profile' && (
                                <>
                                    <ProfileContainer />
                                    <p
                                        className={`text-xs text-gray ${active === 2 && 'text-white'}`}
                                    >
                                        Profile
                                    </p>
                                </>
